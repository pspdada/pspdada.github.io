...
<CardGrid stagger>
  ...
  <Card title="Project" icon="rocket">
    A showcase of projects I've completed—each one marks my growth and capabilities.
    <div style={{ textAlign: "center", marginTop: "0.5em" }}>
  ...
  <Card title="Research" icon="starlight">
    My research work reflects my deeper exploration and curiosity about the world.
    <div style={{ textAlign: "center", marginTop: "0.5em" }}>
